                        ...
                        {items.map((item: any) => (
                            <div key={item.id}>
                                ...
                                {(item.company || item.subtitle || item.issuer) && (
                                    <div style={{ fontSize: '10pt', color: primaryColor, fontWeight: 600, marginBottom: '4px' }}>
                                        {item.company || item.subtitle || item.issuer}
                                    </div>
                                )}
                                {item.technologies && (
                                    <div style={{ fontSize: '9pt', color: '#666', fontFamily: 'monospace', marginBottom: '4px' }}>
        ...
        >
            <div className="resume-template">
                ...
                <div style={{ marginBottom: '40px' }}>
                    <h1 style={{ fontSize: '32pt', fontWeight: 900, lineHeight: 1, marginBottom: '8px', letterSpacing: '-0.03em' }}>
                        {personalInfo.fullName}
                    </h1>
                    <div style={{ fontSize: '14pt', color: primaryColor, fontWeight: 600, marginBottom: '20px' }}>
